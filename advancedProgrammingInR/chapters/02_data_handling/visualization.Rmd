...
```{r gg_bw, tidy = FALSE, fig.cap = fn("a basic ggplot2 bw-plot"), fig.align = 'center'}
## basic frame
...
```{r gg_bw_facet, tidy = FALSE, fig.cap = fn("ggplot2 panel bw-plot"), fig.align = 'center'}
...
```{r gg_hist, tidy = FALSE, fig.cap = fn("a basic histogram produced with ggplot2"), fig.align = 'center', message=FALSE}
## new basic frame
